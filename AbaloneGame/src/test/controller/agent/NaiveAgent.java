...
public class NaiveAgent extends Agent {
    ...
    public NaiveAgent(Player player, Game game) {
        super(player, game);
    }
    ...
    public Move makeMove() {
        ...
        while (directions == null) {
            ...
            for (int[] allDirection : allDirections) {
                if (GameRules.isLegal(new Move(game.getPlayers().size(), player,
                    Collections.singletonList(pickedMarble), allDirection), game.getBoard())) {
