...
public class Board {
    ...
    public static boolean neighbors(int rowA, int colA, int rowB, int colB) {
        return neighbors(rowA + "" + colA, rowB + "" + colB);
    }
    ...
    public static boolean neighbors(String a, String b) {
        ...
        for (int[] dir : allDirections) {
            if (Board.applyVector(a, dir).equals(b)) {
                return true;
            }
        }
        return false;
    ...
    public static String applyVector(String pos, int[] vector) {
        int[] coords = {Integer.parseInt(pos.substring(0, 1)), Integer.parseInt(pos.substring(1))};
        ...
        int[] res = {coords[0] + vec[0], coords[1] + vec[1]};
        return res[0] + "" + res[1];
    }
}
